...
def run() -> tuple[dict, dict]:
    ...
    classifications = {**qualified, **load_provider_descriptive_industry_classes(ROOT, qualified)}
    context = build(product, load_latest_versions(ROOT / "operations-review/persistent-research-dossier-v1-20260820"), classifications)
