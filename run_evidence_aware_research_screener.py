...
def run():
 p=json.loads((ROOT/'operations-review/mva-daily-investment-research-20260820/mva_daily_investment_research_artifact.json').read_text(encoding='utf-8'));e=json.loads((ROOT/'operations-review/strategy-research-eligibility-v1-20260820/strategy_research_eligibility_artifact.json').read_text(encoding='utf-8'));c=json.loads((ROOT/'operations-review/sector-relative-research-context-v1-20260820/sector_relative_research_context_artifact.json').read_text(encoding='utf-8'));pack=json.loads((ROOT/'operations-review/human-research-review-pack-v1-20260820/human_research_review_pack_artifact.json').read_text(encoding='utf-8'));a=build(p,e,c,load_latest_versions(ROOT/'operations-review/persistent-research-dossier-v1-20260820'));return a,review_overlay(pack,a)
