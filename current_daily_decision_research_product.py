...
def _card(ticker: str, tactical: Mapping[str, Any], peer: Mapping[str, Any] | None, fundamental: Mapping[str, Any] | None, valuation: Mapping[str, Any] | None, scenario: Mapping[str, Any] | None, corporate: Mapping[str, Any] | None = None, strategy: Mapping[str, Any] | None = None) -> dict[str, Any]:
...
def build(*, descriptive: Mapping[str, Any], tactical: Mapping[str, Any], peer_relative: Mapping[str, Any], fundamental: Mapping[str, Any], valuation: Mapping[str, Any], scenario: Mapping[str, Any], triage: Mapping[str, Any], corporate_intelligence: Mapping[str, Any] | None = None, strategy_classification: Mapping[str, Any] | None = None) -> dict[str, Any]:
    ...
    c = (corporate_intelligence or {}).get("records") or {}; strategies = (strategy_classification or {}).get("records") or {}
    detailed = sorted(set(WATCHLIST) | set(high_priority) | set(entry_90)); cards = {ticker: _card(ticker, t.get(ticker) or {}, p.get(ticker), f.get(ticker), v.get(ticker), s.get(ticker), c.get(ticker), ({**strategies.get(ticker, {}), "source_artifact_identity": (strategy_classification or {}).get("artifact_identity")} if ticker in strategies else None)) for ticker in detailed if ticker in t}
