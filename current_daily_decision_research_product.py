...
def markdown(artifact: Mapping[str, Any]) -> str:
    ...
    review = artifact["high_priority_full_universe_review_set"]; lines += ["", "## Full-universe discovery", f"- High-priority human-review set: {review['count']}; outside current watchlist: {', '.join(review['outside_watchlist']) or 'none'}.", "- Candidate means human research candidate only, not an investment instruction."]
