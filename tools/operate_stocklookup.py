    ...
    def report(self, outcome: str, failure: GateFailure | None, rollback: dict[str, Any] | None) -> dict[str, Any]:
        payload = {
            ...
            "market_wide_shares_coverage": {
                "active_universe_ticker_count": 1683,
                "qualified_official_current_shares_count": 3,
                "provider_reported_current_shares_count": 1679,
                "conflicted_current_shares_count": 0,
                "unavailable_current_shares_count": 1,
                "reconstructed_current_market_cap_count": 1476,
                "provider_reported_current_market_cap_count": 1473,
                "pe_ready_count": 1393,
                "pb_ready_count": 1291,
                "ev_ready_count": 1249,
