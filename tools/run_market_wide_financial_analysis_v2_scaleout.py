...
def main() -> int:
    ...
    artifact = scaleout.build_scaleout(semantic_rows=rows, feature_records=records, feature_store_artifact=store, period_semantics_identity=semantic["artifact_identity"], requested_at=a.requested_at, legacy_records=legacy)
