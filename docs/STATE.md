...
P3-A remains blocked pending qualified ex-date evidence. The single recommended next gate is **P3-F — bounded valuation/scenario capability design over the P3-E factual readiness matrix**, conditioned on separately qualified market and dated-share inputs; it must not use VCB FY2023 until a separate source-authority decision. Phase 3 execution and strategy layers remain fail-closed.
