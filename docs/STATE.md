...
- Blocker: the qualified issuer-domain/search locator tier found zero acquisition-eligible official URLs for nine frozen ISS candidates; no official byte or VCI window retrieval is authorized.
