...
- Blocker: the bounded issuer-hosted HOSE notice acquisition timed out before retaining document bytes; no directly cited official ex-date/ratio event is available for a VCI window capture.
