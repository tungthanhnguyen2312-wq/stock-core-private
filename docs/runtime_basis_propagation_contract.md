...
2. **Fail-Closed Default:** Unverified or missing basis fields default to `price_basis="unknown"`, `price_basis_verified=False`, `is_actionable=False`, and `volume_basis="raw_shares_traded"`.
