...
`CANONICAL_POST_CLOSE_ONE_COMMAND_PIPELINE_V1 = LIVE_VALIDATED_COMPLETE / READY_FOR_GOVERNED_PUBLICATION` (`push = NO`, publication = separate owner-governed action).
