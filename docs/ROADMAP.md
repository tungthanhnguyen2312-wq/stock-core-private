...
|---:|---|---|
| 1 | Current-share source-authority decision | P3-F5 review is complete: `VCI.overview.issue_share` remains `ISSUED_SHARES` and `AUTHORITY_NOT_PROMOTED_PENDING_OWNER_DECISION`. The evidence supports neither promotion nor market-cap use; acquire independent semantic/effective-date evidence before any owner-approved bounded provider-proxy policy. |
