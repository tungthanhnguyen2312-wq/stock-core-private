...
class DiscoveryTests(unittest.TestCase):
 ...
 def test_only_qualified_issuer_locator_urls_survive(self):
  c={'ticker':'HPG','candidate_ex_date':'2024-01-02'}; rows=official_locator_results(c,'https://news.example/a https://www.hoaphat.com.vn/a.pdf',discovered_at='t',issuer_domains={'HPG':('hoaphat.com.vn',)}); self.assertEqual(len(rows),1)
 def test_search_is_locator_not_evidence(self):
  c={'ticker':'HPG','candidate_ex_date':'2024-01-02'}; r=discover([c],search=lambda _: 'https://www.hoaphat.com.vn/a.pdf',discovered_at='t',issuer_domains={'HPG':('hoaphat.com.vn',)}); self.assertNotIn('qualified_for_price_basis_test',r['locators'][0])
