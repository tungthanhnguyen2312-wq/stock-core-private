...
class FinancialCanonicalizationTests(unittest.TestCase):
    ...
    def test_period_identity_null_zero_negative_and_determinism(self):
        ...
        values={(r['canonical_metric'],r['period_identity']['period']):r['value'] for r in one['records'] if r['period_identity']}; self.assertEqual(values['cash_and_equivalents','2025-Q1'],0); self.assertEqual(values['net_income','2025-Q1'],-2); self.assertIsNone(values['net_income','2025-Q2'])
