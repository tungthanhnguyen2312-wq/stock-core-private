...
class SSISecuritiesPilotTests(unittest.TestCase):
    ...
    def test_only_cited_consolidated_annual_provider_identity_promotes(self):
        row={"metric":"brokerage_revenue","provider":"KBS","reporting_period":"2024","reporting_frequency":"annual","statement_scope":"consolidated","unit":"VND","value":12,"observation_id":"obs","citation_id":"cite","raw_item_id":"revenue_from_brokerage_services"}
