...
def test_eligibility_is_deterministic_and_isolates_blockers():
 ...
 for r in a['records']:
  assert r['lenses']['TREND_MOMENTUM_RESEARCH']['eligibility']=='ELIGIBLE';assert r['lenses']['LIQUIDITY_SENSITIVE_RESEARCH']['eligibility']=='BLOCKED';assert r['lenses']['HISTORICAL_PIT_STRATEGY_RESEARCH']['eligibility']=='BLOCKED';assert r['lenses']['CATALYST_RESEARCH']['eligibility']=='UNAVAILABLE'
