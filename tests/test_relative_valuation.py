...
class T(unittest.TestCase):
 ...
 def test_stale_unknown_share_and_no_target_price(self):
  ...
  x=inputs();x["share_count"]["semantics"]="unknown";self.assertEqual(evaluate_relative_valuation(x)["methods"]["pe"]["state"],"unavailable")
