...
def build(*,portfolio:Mapping[str,Any],descriptive:Mapping[str,Any],tactical:Mapping[str,Any],peer_relative:Mapping[str,Any],fundamental:Mapping[str,Any],valuation:Mapping[str,Any],scenario:Mapping[str,Any],strategy:Mapping[str,Any],corporate_intelligence:Mapping[str,Any],macro_context:Mapping[str,Any]|None=None)->dict[str,Any]:
